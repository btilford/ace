...
var FantomHighlightRules = function() {

    var keywords = lang.arrayToMap(
	("using|as|const|foreach|internal|is|isnot|it|mixin|once|override|readonly|virtual" +
	...
	"float|native|super|while").split("|")
    );
...
oop.inherits(FantomHighlightRules, JavaHighlightRules);

exports.FantomHighlightRules = FantomHighlightRules;
});
